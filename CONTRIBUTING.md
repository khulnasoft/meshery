...
<details>
  ...
  <summary><h3>Find the complete set of contributor guides at https://docs.meshery.khulnasoft.com/project/contributing</h3></summary>
...
All set to contribute? Grab an open issue with the [help-wanted label](../../labels/help%20wanted) and jump in. Join our [Slack channel](https://slack.meshery.khulnasoft.com) and engage in conversation. Create a [new issue](/../../issues/new/choose) if needed. All [pull requests](/../../pulls) should ideally reference an open [issue](/../../issues). Include keywords in your pull request descriptions, as well as commit messages, to [automatically close related issues in GitHub](https://help.github.com/en/github/managing-your-work-on-github/closing-issues-using-keywords).
...
1. Open a pull request (in your web browser) against our main repo: https://github.com/khulnasoft/meshery.
...
4. Fork this repository (`git clone https://github.com/khulnasoft/meshery.git`), and clone your forked version of Meshery to your development environment, preferably outside `GOPATH`.
...
- `git remote add upstream https://github.com/khulnasoft/meshery`
- `git fetch upstream`
...
_Tip:_ The [Meshery adapter for Istio](https://github.com/khulnasoft/meshery-istio) is a good reference adapter to use as an example of a Meshery adapter written in Go.
...
1. Fork [Meshery-Istio](https://github.com/khulnasoft/meshery-istio)
...
- In case you are unable to fix your lint errors, ping us on our [Slack](https://slack.meshery.khulnasoft.com).
...
Please refer to the [Meshery Contributing Guidelines](https://docs.meshery.khulnasoft.com/project/contributing/contributing-cli) for setting up your development environment and the [mesheryctl Command Reference and Tracker](https://docs.google.com/spreadsheets/d/1q63sIGAuCnIeDs8PeM-0BAkNj8BBgPUXhLbe1Y-318o/edit#gid=0) for current status of `mesheryctl`.
...
The [`/mesheryctl`](https://github.com/khulnasoft/meshery/tree/master/mesheryctl) folder contains the complete code for `mesheryctl`.
...
- See user-facing, documentation of the `mesheryctl` commands is available in the [Meshery Docs](https://docs.meshery.khulnasoft.com/reference/mesheryctl).
...
All contributors are invited to review [pull requests](https://github.com/khulnasoft/meshery/pulls) on `mesheryctl` as on other Layer5 projects.
