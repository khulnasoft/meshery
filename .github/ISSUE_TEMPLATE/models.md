...
### Contributor [Guides](https://docs.meshery.khulnasoft.com/project/contributing) and [Handbook](https://layer5.io/community/handbook)

- [Models Repository](https://github.com/khulnasoft/meshery/tree/master/server/meshmodel)
...
- 🙋🏾🙋🏼 Questions: [Discussion Forum](http://discuss.meshery.khulnasoft.com) and [Community Slack](https://slack.meshery.khulnasoft.com)

## Contributing to Meshery Models

!! See https://docs.meshery.khulnasoft.com/project/contributing/contributing-models
...
1. Propose a specific visual representation for the relationship. See example on [Modeling Relationships.](https://docs.meshery.khulnasoft.com/project/contributing/contributing-models)
...
1. Review a prior pull request as an example of how to define a Relationships: https://github.com/khulnasoft/meshery/pull/9880/files
