...
// https://docs.meshery.khulnasoft.com/project/contributing/contributing-error
...
func ErrNoProfileFound() error {
	return errors.New(ErrNoProfileFoundCode, errors.Alert,
		...
		[]string{"Ensure a valid profile name is inputted. See https://docs.meshery.khulnasoft.com/reference/mesheryctl/perf/apply for more details"})
}
...
func ErrInvalidTestConfigFile() error {
	return errors.New(ErrInvalidTestConfigFileCode,
		...
		[]string{"See https://docs.meshery.khulnasoft.com/guides/performance-management#running-performance-benchmarks-through-mesheryctl for a valid configuration file"})
}

func formatErrorWithReference() string {
	baseURL := "https://docs.meshery.khulnasoft.com/reference/mesheryctl/perf"
	switch cmdUsed {
	case "apply":
...
func ErrHealthChecker(err error) error {
	return errors.New(ErrHealthCheckerCode,
		...
		[]string{"Ensure Mesheryctl is running and has the right configurations. See https://docs.meshery.khulnasoft.com/reference/mesheryctl/system/check for checking Meshery components"})
}
