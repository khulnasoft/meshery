...
var (
	cmdType     string
	contextdocs string = "See https://docs.meshery.khulnasoft.com/reference/mesheryctl/system/context for usage details."
...
func FormatErrorReference() string {
	baseURL := "https://docs.meshery.khulnasoft.com/reference/mesheryctl/system"
	switch cmdType {
	case "channel":
