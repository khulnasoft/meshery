...
var (
	...
	ErrNoAdapters = errors.New(ErrNoAdaptersCode, errors.Fatal,
		...
		[]string{"Run the appropriate Meshery Adapter for your specific use case. See https://docs.meshery.khulnasoft.com/concepts/architecture/adapters for list of adapters"})
