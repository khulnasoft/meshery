...
Please refer the [Meshery Contributing Guidelines](https://github.com/khulnasoft/meshery/blob/master/CONTRIBUTING.md) for setting up your development environment.
...
Detailed documentation of the `mesheryctl` commands is available in the [Meshery Docs](https://docs.meshery.khulnasoft.com/reference/mesheryctl).
