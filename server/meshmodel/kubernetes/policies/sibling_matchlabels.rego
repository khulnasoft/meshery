...
#   get_tag_keys("annotations") := {"meshery.khulnasoft.com/namespace", "meshery.khulnasoft.com/service"} for input {"annotations": {"meshery.khulnasoft.com/namespace": "default", "meshery.khulnasoft.com/service": "redis"}}
