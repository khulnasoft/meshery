...
var (
	...
	ErrParsingTest             = errors.New(ErrParsingTestCode, errors.Alert, []string{"error parsing test duration, please refer to: https://docs.meshery.khulnasoft.com/guides/mesheryctl#performance-management"}, []string{}, []string{}, []string{})
