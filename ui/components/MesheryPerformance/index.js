...
const infoloadGenerators = (
  <>
    ...
    <Link
      ...
      color="inherit"
      href="https://docs.meshery.khulnasoft.com/functionality/performance-management"
    >
      {' '}
                      ...
                      <Grid container spacing={1}>
                        <Grid item xs={12}>
                          <TextField
                            id="headers"
                            name="headers"
                            label='Request Headers e.g. {"host":"bookinfo.meshery.khulnasoft.com"}'
                            fullWidth
                            value={headersState}
                            multiline
                            margin="normal"
                        ...
                        <Grid item xs={12} md={12}>
                          <TextField
                            id="cookies"
                            name="cookies"
                            label='Request Body e.g. {"method":"post","url":"http://bookinfo.meshery.khulnasoft.com/test"}'
                            fullWidth
                            value={reqBodyState}
                            multiline
                            margin="normal"
