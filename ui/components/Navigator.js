...
const externlinks = [
  {
    id: 'doc',
    href: 'https://docs.meshery.khulnasoft.com',
    title: 'Documentation',
  ...
  {
    id: 'community',
    href: 'https://slack.meshery.khulnasoft.com',
    title: 'Community',
    icon: (
      <SlackIcon
  ...
  {
    id: 'forum',
    href: 'http://discuss.meshery.khulnasoft.com',
  ...
  {
    id: 'issues',
    href: 'https://github.com/khulnasoft/meshery/issues/new/choose',
    title: 'Issues',
...
class Navigator extends React.Component {
    ...
    if (outdated)
      return (
        <span style={{ marginLeft: '15px' }}>
          {'Update available '}
          <a
            href={`https://docs.meshery.khulnasoft.com/project/releases/${latest}`}
            target="_blank"
            rel="noreferrer"
            style={{ color: 'white' }}
          >
  ...
  openReleaseNotesInNew() {
    ...
    if (release_channel === 'edge')
      return (
        <a
          href="https://docs.meshery.khulnasoft.com/project/releases"
          target="_blank"
          rel="noreferrer"
          style={{ color: 'white' }}
        >
    ...
    return (
      <a
        href={`https://docs.meshery.khulnasoft.com/project/releases/${build}`}
        target="_blank"
        rel="noreferrer"
        style={{ color: 'white' }}
      >
