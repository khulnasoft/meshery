          ...
          <div className={classes.list}>
            ...
            <Collapse in={isSocialShareOpen}>
              <Box className={classes.socialListItem}>
                <FacebookShareButton url={'https://meshery.khulnasoft.com'} quote={event.description || ''}>
                  <FacebookIcon {...iconMedium} fill={theme.palette.secondary.iconMain} />
                </FacebookShareButton>
                <LinkedinShareButton url={'https://meshery.khulnasoft.com'} summary={event.description || ''}>
                  <LinkedInIcon {...iconMedium} fill={theme.palette.secondary.iconMain} />
                </LinkedinShareButton>
                <TwitterShareButton url={'https://meshery.khulnasoft.com'} title={event.description || ''}>
