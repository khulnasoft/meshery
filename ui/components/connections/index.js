...
function Connections(props) {
  ...
  const url = `https://docs.meshery.khulnasoft.com/concepts/logical/connections#states-and-the-lifecycle-of-connections`;
  const envUrl = `https://docs.meshery.khulnasoft.com/concepts/logical/environments`;
  ...
  const handleStatusChange = async (e, connectionId, connectionKind) => {
    ...
    let response = await modalRef.current.show({
      ...
      options: ['Confirm', 'No'],
      showInfoIcon: `Learn more about the [lifecycle of connections and the behavior of state transitions](https://docs.meshery.khulnasoft.com/concepts/logical/connections) in Meshery Docs.`,
