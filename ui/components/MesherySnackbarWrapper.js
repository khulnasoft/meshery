...
const generateMsgForAppsPatt = (name) => {
  return `I deployed ${name} [design | application] in a single-click using @mesheryio!\nFind design patterns like mine in the Meshery Catalog - https://meshery.khulnasoft.com/catalog`;
};
...
function MesherySnackbarWrapper(props) {
  ...
  const ERROR_DOC_LINK = 'https://docs.meshery.khulnasoft.com/reference/error-codes';
                ...
                <Fade {...TransitionProps} timeout={350}>
                  <Paper className={classes.paper}>
                    <TwitterShareButton
                      ...
                      url={'https://meshery.khulnasoft.com'}
                      title={socialMessage}
                      hashtags={['opensource']}
                    >
                      <TwitterIcon size={32} />
