...
const Environments = ({ organization, classes }) => {
  ...
  const handleDeleteEnvironmentConfirm = async (e, environment) => {
    ...
    let response = await modalRef.current.show({
      ...
      Learn more about the behavior of [lifecycle of environments and their resources](https://docs.meshery.khulnasoft.com/concepts/logical/environments) in Meshery Docs.`,
