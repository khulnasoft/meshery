...
`mesheryctl` can be installed via [bash]({{site.baseurl}}/installation/bash), [Homebrew]({{site.baseurl}}/installation/linux-mac/brew), [Scoop]({{site.baseurl}}/installation/windows/scoop) or [directly downloaded](https://github.com/khulnasoft/meshery/releases/latest).
