...
Please do! Thanks for your help! 🎈 Meshery is community-built and welcomes collaboration. Contributors are expected to adhere to the [CNCF's Code of Conduct](https://github.com/khulnasoft/meshery/blob/master/CODE_OF_CONDUCT.md).
...
- **Discuss** with the community by engaging in the [discussion forum](http://discuss.meshery.khulnasoft.com).
- **Contribute** by grabbing any open issue with the [help-wanted label](https://github.com/khulnasoft/meshery/issues/) and jump in. If needed, create a [new issue](https://github.com/khulnasoft/meshery/issues/new/choose). All [pull requests](https://github.com/khulnasoft/meshery/pulls) should reference an open issue. Include keywords in your pull request descriptions, as well as commit messages, to [automatically close issues in GitHub](https://help.github.com/en/github/managing-your-work-on-github/closing-issues-using-keywords).
...
<li> Fork this repository <code>git clone https://github.com/khulnasoft/meshery.git</code>, and clone your forked version of Meshery to your development environment, preferably outside `GOPATH`.</li>
