...
Tip: The [Meshery Adapter for Istio](https://github.com/khulnasoft/meshery-istio) is a good reference adapter to use as an example of a Meshery Adapter.
