...
| GitHub     | mesheryctl                                      | [https://github.com/khulnasoft/meshery/releases](https://github.com/khulnasoft/meshery/releases)                         |
| Docker Hub | Meshery Adapter for \<adapter-name\>            | https://hub.docker.com/r/meshery/meshery-\<adapter-name>\>                                                             |
| Docs       | Meshery Documentation                           | [https://docs.meshery.khulnasoft.com](https://docs.meshery.khulnasoft.com)                                                                   |
...
| Github     | Helm charts                                     | [https://github.com/khulnasoft/meshery.khulnasoft.com/tree/master/charts](https://github.com/khulnasoft/meshery.khulnasoft.com/tree/master/charts) |
...
Only when a git tag containing a semantic version number is present (is a commit in the master branch) will GoReleaser execute, generate the archives, and also publish the archives to [Meshery’s GitHub releases](https://github.com/khulnasoft/meshery/releases) automatically. GoReleaser is configured to generate artifacts for the following OS, ARCH combination:
...
GoReleaser facilitates the creation of a brew formula for mesheryctl. The [homebrew-tap](https://github.com/khulnasoft/homebrew-tap) repository is the location for Layer5’s brew formulas.

#### Scoop

GoReleaser facilitates the creation of a Scoop app for mesheryctl. The [scoop-bucket](https://github.com/khulnasoft/scoop-bucket) repository is the location of Layer5’s Scoop bucket.
...
New Meshery Helm charts are published upon trigger of a release event in the `meshery/meshery` repo. New versions of Meshery's Helm charts are published to [Meshery's Helm charts release page](https://github.com/khulnasoft/meshery.khulnasoft.com/tree/master/charts). [Artifact Hub] (https://artifacthub.io/packages/helm/meshery/meshery) syncs with these updated Meshery Helm charts.
...
The sending of release notes is now automated as a step in the stable release channel workflow. The release notes are automatically sent to the [developers@meshery.khulnasoft.com mailing list](https://groups.google.com/a/meshery.khulnasoft.com/g/developers).
