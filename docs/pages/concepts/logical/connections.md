...
1. a ConnectionDefinition based Meshery's [Connection Schema](https://github.com/khulnasoft/schemas/blob/master/openapi/schemas/connections.yml) with hand-curated Connection attributes.
