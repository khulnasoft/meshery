...
---
Meshery uses one or more Credentials when authenticating to a managed or unmanaged Connection. Credentials are based on the Meshery's [Credential Schema](https://github.com/khulnasoft/schemas/blob/master/openapi/schemas/credentials.yml) with defined attributes.
