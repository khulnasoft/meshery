...
You can use [Meshery SMI Conformance GitHub action](https://github.com/khulnasoft/meshery-smi-conformance-action) to run SMI Conformance tests in your CI/CD pipelines.
