...
_See [Meshery Catalog](https://meshery.khulnasoft.com/catalog)_.
...
{% include alert.html
    ...
    content="A central set of design patterns is available in Meshery Catalog (<a href='/concepts/catalog'>concept</a>, <a href='https://meshery.khulnasoft.com/catalog'>site</a>)." %}
