...
**_The need for authentication to `Meshery` [provider](https://docs.meshery.khulnasoft.com/extensibility/providers) is to save your environment setup while also having persistent/steady sessions and to be able to retrieve performance test results._**
