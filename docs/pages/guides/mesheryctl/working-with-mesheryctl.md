...
Install `mesheryctl` and run Meshery on Mac or Linux with this script:
 ...
 <pre class="codeblock-pre"><div class="codeblock">
 <div class="clipboardjs">
 curl -L https://meshery.khulnasoft.com/install | bash -
 </div></div>
 </pre>
...
Download and unzip `mesheryctl` from the [Meshery releases](https://github.com/khulnasoft/meshery/releases/) page. Add `mesheryctl` to your PATH for ease of use. Then, execute:
...
Add the Meshery Scoop Bucket and install:
 ...
 <pre class="codeblock-pre"><div class="codeblock">
 <div class="clipboardjs">
 scoop bucket add mesheryctl https://github.com/khulnasoft/scoop-bucket.git
