...
The MeshSync CRD is used as a configuration tool the [MeshSync](https://docs.meshery.khulnasoft.com/concepts/architecture/MeshSync). The CRD is used to control the replica count for MeshSync instances, [Broker](https://docs.meshery.khulnasoft.com/concepts/architecture/broker) configuration and the resources that MeshSync watches and listens to in a cluster.
...
- **spec**
  ...
  - **broker**:
    This section contains the configuration for [Broker](https://docs.meshery.khulnasoft.com/concepts/architecture/broker)
    - **native**:
...
The Custom Resource is used to configure the [Broker](https://docs.meshery.khulnasoft.com/concepts/architecture/broker) and Events to be tracked by [MeshSync](https://docs.meshery.khulnasoft.com/concepts/architecture/MeshSync)
