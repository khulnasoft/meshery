...
#### Option 1: Only install `mesheryctl` binary
 ...
 <div class="clipboardjs">
  $ curl -L https://meshery.khulnasoft.com/install | DEPLOY_MESHERY=false bash -
 </div></div>
 </pre>
...
#### Option 2: Install `mesheryctl` binary and deploy Meshery on Docker
 ...
 <div class="codeblock">
 <div class="clipboardjs">
  $ curl -L https://meshery.khulnasoft.com/install | PLATFORM=docker bash -
 </div></div>
 </pre>
...
#### Option 3: Install `mesheryctl` binary and deploy Meshery on Kubernetes
 ...
 <div class="codeblock">
 <div class="clipboardjs">
  $ curl -L https://meshery.khulnasoft.com/install | PLATFORM=kubernetes bash -
 </div></div>
 </pre>
...
Install `mesheryctl` binary and include one or more [adapters]({{ site.baseurl }}/concepts/architecture/adapters) to be deployed
 ...
 <div class="codeblock">
 <div class="clipboardjs">
  $ curl -L https://meshery.khulnasoft.com/install | ADAPTERS=consul PLATFORM=kubernetes bash -
 </div></div>
 </pre>
