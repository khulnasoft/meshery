                ...
                >
                  {userDesigns?.patterns.length > 0 ? (
                    ...
                    <div>
                      ...
                      <a href={user?.role_names?.includes(MESHMAP) ? "https://playground.meshery.khulnasoft.com/extension/meshmap" : "https://play.meshery.khulnasoft.com"} style={{ textDecoration: "none" }}>
                      <PublishCard>
        ...
        <SectionWrapper>
          {isLoggedIn && (
            <div style={{ paddingTop: isLoggedIn ? '1.2rem' : null }}>
              ...
              <a
                href={`https://docs.meshery.khulnasoft.com/project/releases/${mesheryVersion}`}
                target="_blank"
                rel="noreferrer"
