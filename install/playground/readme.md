...
### DNS
playground.meshery.khulnasoft.com - 147.28.141.9
...
2. `kubectl create secret tls -n meshery tls-secret-meshery --cert=/etc/letsencrypt/live/playground.meshery.khulnasoft.com-0001/fullchain.pem --key=/etc/letsencrypt/live/playground.meshery.khulnasoft.com-0001/privkey.pem`  Make sure to have private and public keys generated for `playground.meshery.khulnasoft.com` in appropriate directories.
...
```
	location /api/system/graphql/query {
	   ...
	   proxy_pass http://meshery-meshery-playground.meshery.khulnasoft.com-meshery-9082;
	 }
...
- Run sudo certbot certonly --manual --preferred-challenges http -d playground.meshery.khulnasoft.com and press 2 to renew the certificates. 
- New certs will be stored at /etc/letsencrypt/live/playground.meshery.khulnasoft.com/fullchain.pem and /etc/letsencrypt/live/playground.meshery.khulnasoft.com/privkey.pem
...
- Run `kubectl create secret tls tls-secret --cert=/etc/letsencrypt/live/playground.meshery.khulnasoft.com/fullchain.pem --key=/etc/letsencrypt/live/playground.meshery.khulnasoft.com/privkey.pem`  and `kubectl create secret tls nginx-ingress-default-server-tls --cert=/etc/letsencrypt/live/playground.meshery.khulnasoft.com/fullchain.pem --key=/etc/letsencrypt/live/playground.meshery.khulnasoft.com/privkey.pem`
