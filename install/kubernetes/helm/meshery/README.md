...
| Name | Email | Url |
| ---- | ------ | --- |
| Meshery Authors | <maintainers@meshery.khulnasoft.com> |  |
...
```console
helm repo add meshery meshery https://meshery.khulnasoft.com/charts/
helm repo update
```
...
Eg: For [Meshery Adapter for Istio](https://github.com/khulnasoft/meshery-istio)
```console
kubectl create namespace meshery
